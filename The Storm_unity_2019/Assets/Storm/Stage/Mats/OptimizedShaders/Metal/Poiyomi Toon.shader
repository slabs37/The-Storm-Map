Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/3a54d2ec62d081640a3d4f0f35008f4d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.365 /*_MochieRoughnessMultiplier*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.151 /*_RefSpecFresnelStrength*/)) * (0.151 /*_RefSpecFresnelStrength*/), pbrNDotV);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.02207365,0.02207365,0.02207365,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.02207365,0.02207365,0.02207365,1).a;
