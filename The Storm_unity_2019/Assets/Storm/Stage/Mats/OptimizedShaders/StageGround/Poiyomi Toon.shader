Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1738a4992478ba3419d9b0844182b6b7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(10,5,0,0)), float4(0,0,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (1.0 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.587 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.02968646,0.01778136,0.007790096,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.02968646,0.01778136,0.007790096,1).a;
