Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/73746acd5d676a843adf164de97c24e0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(5,5,0,0)), float4(0,0,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (2.0 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			{
				float smoothness = (0.31 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.26 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (1.0 /*_BumpMapStochastic*/)), (2.0 /*_BumpScale*/));
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.04539379,0.02487092,0.008874486,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.04539379,0.02487092,0.008874486,1).a;
